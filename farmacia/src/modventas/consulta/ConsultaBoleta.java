...
public class ConsultaBoleta extends SelectorComposer{
    ...
    @Listen("onCreate=window#winBoleta")
    public void onCreate() throws NamingException {   
        HtmlMacroComponent macro = (HtmlMacroComponent) winBoleta.getFellow("mimpresion");
    ...
    private void buscarComprobante(){
        ...
        Documento documento=documentoService.buscarPorCcodigosunat(Documento.BOLETA_SUNAT.getCcodigosunat());
