...
public class ManttoMotivoNotcarProveedor extends SelectorComposer implements CrudListener{
    
    private MotivoNotcarProveedor motivo=new MotivoNotcarProveedor();
    ...
    public void onCreate() throws NamingException {
        HtmlMacroComponent macro = (HtmlMacroComponent) Path.getComponent("/winMotivonotcar/menuMantto");
    ...
    public void limpiar() {
        quitarConstraint();
        habilitar(false);
        motivo=new MotivoNotcarProveedor();
        txtNombre.setText("");
        agregarConstraint();
    }
    ...
    @Override
    public void buscar() {
        Window winbuscaprod = (Window) Executions.createComponents("/modulos/mantenimiento/util/busquedamotivonotcarproveedor.zul", null, null);
        ...
        if (rest) {
            ...
            motivo = (MotivoNotcarProveedor) modelobuscado.getElementAt(lstproducto1.getSelectedIndex());
            escribir();
        }
    }
    ...
    @Override
    public void grabar() {        
        motivoNotcarProveedorService.registrar(motivo);
        Messagebox.show("Registro Satisfactorio");
    }

    @Override
    public void actualizar() {
        motivoNotcarProveedorService.actualizar(motivo);
        Messagebox.show("Registro Satisfactorio");
    }
    ...
    public void eliminar() {
        ...
        if (resp == Messagebox.OK) {
            motivoNotcarProveedorService.eliminar(motivo);
            motivo=new MotivoNotcarProveedor();
