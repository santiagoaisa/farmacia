...
@NamedQueries({
    ...
    @NamedQuery(name = "Existencia.findByIdalmacenByIdlineasByNstock", query = "SELECT e FROM Existencia e WHERE e.idalmacen.idalmacen=:idalmacen and e.idproducto.idsublinea.idlinea.idlinea in (:lista) and (e.nstock>0 or e.nstockm>0) ORDER BY e.idproducto.idsublinea.idlinea.cnomlinea,e.idproducto.cnomproducto "),
    ...
    @NamedQuery(name = "Existencia.findByIdalmacenByIdlinea", query = "SELECT e FROM Existencia e WHERE e.idalmacen.idalmacen=:idalmacen and e.idproducto.idsublinea.idlinea.idlinea=:idlinea ORDER BY e.idproducto.idsublinea.idlinea.cnomlinea, e.idproducto.cnomproducto "),
