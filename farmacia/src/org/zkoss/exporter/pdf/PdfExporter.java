...
public class PdfExporter extends AbstractExporter<PdfPTable, PdfPTable> {
    ...
    public void exportTabularComponent(MeshElement component, OutputStream outputStream, String cnombre) throws Exception {
        Document document = getDocumentFactory().getDocument();
        getPdfWriterFactory().getPdfWriter(document, outputStream);
        document.open();
    ...
    protected void exportDataModel(String[] headers, String[] fields, ListModelList dataModel, OutputStream outputStream, String cnombre) throws Exception {
        ...
        lstExportar.setItemRenderer(new ListitemRedenderZarcillo(headers));
        ...
        exportHeaders(columnSize, lstExportar, table);
        exportRows(columnSize, lstExportar, table);
        exportFooters(columnSize, lstExportar, table);
