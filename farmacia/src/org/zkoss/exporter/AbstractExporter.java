...
public abstract class AbstractExporter<E, T> {
     ...
     * @param component
     * @param outputStream
     * @param nombre de la hoja
     * @throws Exception
     */
    protected abstract void exportTabularComponent(MeshElement component, OutputStream outputStream, String cnombre) throws Exception;

    /**
     * Export cabeceras campos
     *
     * @param cabeceras
     * @param campos
     * @param modelo
     ...
     * @throws Exception
     */
    protected abstract void exportDataModel(String[] headers, String[] fields, ListModelList dataModel, OutputStream outputStream, String cnombre) throws Exception;
     ...
     * {@link #setInterceptor(Interceptor)}} if wish to render header
     * differently
     *
     *
     * @param columnHeaders
     ...
     * @param component
     * @param outputStream
     * @param nombre de hoja
     * @throws Exception
     */
    public void export(MeshElement component, OutputStream outputStream, String cnombre) throws Exception {
        if (component == null) {
            throw new RuntimeException("export target reference is null");
        }

        if (component instanceof Grid || component instanceof Listbox) {
            exportTabularComponent(component, outputStream, cnombre);
        } else {
     ...
     * @throws Exception
     */
    public void export(String[] headers, String[] fields, ListModelList dataModel, OutputStream outputStream, String cnombre) throws Exception {
        if (dataModel == null) {
        ...
        exportDataModel(headers, fields, dataModel, outputStream, cnombre);
    }
